...
class TodoHistoryContext(val todoId: Int) : ScrollContext()
...
object TodoHistoryInterface : ScrollInterface<TodoHistoryContext, HistoryEntry>(
    ...
    ScrollInterfaceOptions<TodoHistoryContext>().apply {
        scrollDirection = ScrollInterface.ScrollDirection.TOP_BOTTOM
        inventorySize = 9 * 2
        contentArea = (0 to 0) to (6 to 1)
    ...
    override fun getOtherItems(): List<InterfaceItem<TodoHistoryContext>> = listOf(
        item()
            .atSlot(8)
